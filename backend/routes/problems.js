...
router.get("/:slug", async (req, res) => {
  try {
    const problem = await Problem.findOne({ slug: req.params.slug })
      .select("-standardDesign.keyFlows -standardDesign.scalabilityDecisions -standardDesign.faultToleranceMechanisms"); // helps to provide hint to the user or that design
